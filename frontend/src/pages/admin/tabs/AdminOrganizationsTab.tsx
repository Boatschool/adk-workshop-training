 ...
 * Organization (tenant) management content for the admin console
 * Renamed from "Tenants" to "Organizations" for user-friendly terminology
 */
    ...
    <div>
      ...
      <CreateOrganizationModal
        ...
        onSubmit={async (data) => {
          ...
          showToast('Organization created and provisioned successfully', 'success')
...
function CreateOrganizationModal({ isOpen, onClose, onSubmit, isLoading }: CreateOrganizationModalProps) {
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
          <p className="text-sm text-blue-700 dark:text-blue-300">
            <strong>Note:</strong> Creating an organization will provision a new database schema
...
function EditOrganizationModal({ tenant, isOpen, onClose, onSubmit, isLoading }: EditOrganizationModalProps) {
