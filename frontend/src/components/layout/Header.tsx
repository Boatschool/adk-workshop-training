      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            {/* Setup Wizard Button - only for new users who haven't completed setup */}
            {!settings.setupCompleted && (
              <Link
                to="/getting-started"
                className="mr-2 px-3 py-1.5 text-sm font-medium bg-amber-500 hover:bg-amber-600 dark:bg-amber-600 dark:hover:bg-amber-500 text-white rounded-lg transition-colors inline-flex items-center gap-1.5"
              >
            ...
            <nav className="flex flex-col space-y-1">
              ...
              {!settings.setupCompleted && (
                <Link
                  to="/getting-started"
                  onClick={toggleMobileMenu}
                  className="mx-3 mt-2 px-4 py-2.5 text-base font-medium bg-amber-500 hover:bg-amber-600 dark:bg-amber-600 dark:hover:bg-amber-500 text-white rounded-lg transition-colors inline-flex items-center gap-2"
                >
